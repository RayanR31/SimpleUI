namespace FlowUI
{
    ...
    public class UIPageTransition
    {
        ...
        [Header("Exit Transition")] [Tooltip("Invoked when the page is about to be hidden.")] [SerializeField]
        private UnityEvent onExit;

        [Tooltip("Duration of the exit transition in seconds.")] [Min(0f)] [SerializeField]
